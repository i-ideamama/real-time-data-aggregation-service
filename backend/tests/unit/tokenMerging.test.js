...
const tokenMerging_service_1 = require("../../src/services/tokenMerging.service");
describe('TokenMergingService', () => {
    const service = new tokenMerging_service_1.TokenMergingService();
    ...
    describe('deduplicateByAddress', () => {
        it('should merge tokens with same address', () => {
            ...
            const token2 = Object.assign(Object.assign({}, token1), { price_sol: null, volume_usd: 200, sources: ['source2'] });
