...
const toNum = (v) => (v == null ? null : Number(v) || null);
...
function fetchAllJupPages(query) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (url) {
            ...
            url = (_a = data.next_url) !== null && _a !== void 0 ? _a : null; // follow cursor
        }
        return all;
    });
}
const checkAPI = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const [jupResp, dexResp, cgResp] = yield Promise.allSettled([
            axios_1.default.get("https://lite-api.jup.ag/tokens/v2/search?query=" + currentCoin),
            axios_1.default.get("https://api.dexscreener.com/latest/dex/search?q=" + currentCoin),
            axios_1.default.get("https://api.coingecko.com/api/v3/simple/price?ids=solana&vs_currencies=usd").catch(() => null),
        ]);
        ...
        const jList = yield fetchAllJupPages(currentCoin);
        ...
        if (!solUsd)
            solUsd = (_f = toNum((_d = (_c = cg === null || cg === void 0 ? void 0 : cg.solana) === null || _c === void 0 ? void 0 : _c.usd) !== null && _d !== void 0 ? _d : (_e = cg === null || cg === void 0 ? void 0 : cg.sol) === null || _e === void 0 ? void 0 : _e.usd)) !== null && _f !== void 0 ? _f : null;
        ...
        return res.status(500).json({ message: "internal error", error: (_g = err === null || err === void 0 ? void 0 : err.message) !== null && _g !== void 0 ? _g : String(err) });
    }
});
